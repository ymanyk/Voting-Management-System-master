...
public    void show()
      ...
      try {
         Class.forName("org.postgresql.Driver");
         c1 = DriverManager.getConnection("jdbc:postgresql://localhost:5432/postgres", "postgres", "123");
         ...
         stmt1 = c1.createStatement();
            ...
            if(max==res)
            {
                System.out.println("FOCS is winner");
            }
            int res1=rs1.getInt(2);
            if(max==res)
            {System.out.println("FOIT is winner");
            }
            int res3=rs1.getInt(3);
            if(max==res)
            {System.out.println("FAFB is winner");
            }
            int res4=rs1.getInt(4);
            if(max==res)
            {System.out.println("FOAS is winner");
            }
            int res5=rs1.getInt(5);
            if(max==res)
            {System.out.println("FOBE is winner");
            }
